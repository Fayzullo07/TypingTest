...
userInput.addEventListener("input", () => {
    ...
    quoteChars.forEach((char, index) => {
        ...
        // If user hasn't entered anything or backspased
        ...
        // If user enter wrong character
            ...
            // Checks if we alread have added fail class
...
const displayResult = () => {
    ...
    clearInterval(timer);
    document.getElementById("stop_test").style.display = "none";
    ...
    document.getElementById("accuary").innerHTML = Math.round(((userInput.value.length - mistakes) / userInput.value.length) * 100) + "%`";
...
const startTest = () => {
    ...
    document.getElementById("stop_test").style.display = "block";
